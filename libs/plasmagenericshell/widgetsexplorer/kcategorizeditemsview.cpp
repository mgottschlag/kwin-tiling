...
void KCategorizedItemsView::itemClicked(const QModelIndex &index)
{
    AbstractItem *item = (AbstractItem *)m_modelItems->
                         itemFromIndex(m_modelFilterItems->mapToSource(index));
    emit clicked(item);
}

void KCategorizedItemsView::itemEntered(const QModelIndex &index)
{
    AbstractItem *item = (AbstractItem *)m_modelItems->
                         itemFromIndex(m_modelFilterItems->mapToSource(index));
    emit entered(item);
