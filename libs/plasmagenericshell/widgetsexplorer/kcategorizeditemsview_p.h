...
private slots:
    ...
    //slots to handle the index and pass it to the applet info view
...
Q_SIGNALS:
    ...
    //signals to emit the selected applet item to the applet info view
    void clicked(AbstractItem *appletItem);
    void entered(AbstractItem *appletItem);
...
private:
    ...
    friend class AppletsListSearch;
};
