...
@ARGV != 2 && pegout("usage: $0 <def-file> <ci-file>");

open (INFILE, $ARGV[0]) || pegout("$0: cannot open definition file ".$ARGV[0]);
open (OUTFILE, ">".$ARGV[1]) || pegout("$0: cannot open output file ".$ARGV[1]);
print OUTFILE "/* auto-generated by $0 - DO NOT EDIT! */\n\n";
