...
void KGeneralModule::setDirty()
{
	emit changed(true);
}

void KGeneralModule::defaults()
{
...
QString KGeneralModule::quickHelp()
{ 
	return i18n("<h1>General Settings</h1>This module allows you to define "
