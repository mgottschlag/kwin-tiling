#ifndef __KFONT_VIEW_PART_FACTORY_H__
#define __KFONT_VIEW_PART_FACTORY_H__
...
class KFontViewPartFactory : public KLibFactory
{
    Q_OBJECT

    public:

    KFontViewPartFactory();
    virtual ~KFontViewPartFactory();
