/*
 * kmenubutton.h - Button with language selection drop down menu.
...
#ifndef __KMENUBUTTON_H__
#define __KMENUBUTTON_H__
 ...
 * instead.
 */
class KMenuButton : public QPushButton
{
  Q_OBJECT

public:
  KMenuButton(QWidget *parent=0, const char *name=0);
  virtual ~KMenuButton();
