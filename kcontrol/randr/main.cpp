...
{
	KAboutData aboutData("krandr", I18N_NOOP("Size and Rotation"), krandrtrayVersion, I18N_NOOP("Resize and Rotate System Tray App"), KAboutData::License_GPL, "(c) 2002,2003 Hamish Rodda", 0L, "");
