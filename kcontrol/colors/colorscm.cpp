...
KCMColorScheme::KCMColorScheme(QWidget *parent, const QVariantList &)
...
KCMColorScheme::~KCMColorScheme()
{
}


void KCMColorScheme::load()
{
...
void KCMColorScheme::sliderValueChanged( int val )
{
    cs->contrast = val;
    cs->drawSampleWidgets();
...
void KCMColorScheme::slotRemove()
{
...
void KCMColorScheme::slotImport()
{
...
QColor &KCMColorScheme::color(int index)
{
    switch(index) {
...
void KCMColorScheme::slotColorForWidget(int indx, const QColor& col)
{
    mColorTreeWidget->setColor( indx , col );
}

void KCMColorScheme::slotShadeSortColumnChanged(bool b)
{
 ...
 */
void KCMColorScheme::readScheme( int index )
{
 ...
 */
void KCMColorScheme::readSchemeNames()
{
    mSchemeList.clear();
    sList->clear();
 ...
 */
int KCMColorScheme::findSchemeByName(const QString &scheme)
{
   if (scheme.isEmpty())
      return 0;
   if (scheme == "<default>")
...
void KCMColorScheme::slotPreviewScheme(int indx)
{
    readScheme(indx);
...
/* this function should dissappear: colorscm should work directly on a Qt palette, since
   ...
   */
QPalette KCMColorScheme::createPalette()
{
...
void KCMColorScheme::insertEntry(const QString &sFile, const QString &sName)
{
...
void KCMColorScheme::setColorName( const QString & name, int id , int id2 )
{
    mColorTreeWidget->addRole( id , id2, name );
}

void KCMColorScheme::slotColorChanged( int selection , const QColor & col)
{
