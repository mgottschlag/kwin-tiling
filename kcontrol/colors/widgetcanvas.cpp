                                        ...
                                        const QColor &disMed)
{
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  close_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  close_dgray_bits);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  close_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  iconify_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  iconify_dgray_bits);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  iconify_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  maximize_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  maximize_dgray_bits);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  maximize_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  maximizedown_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  maximizedown_dgray_bits);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  maximizedown_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  menu_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  menu_dgray_bits);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  menu_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  pinup_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  pinup_gray_bits);
    pact.setPen(actMed); pdis.setPen(disMed);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  pinup_dgray_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  pinup_mask_bits);
    ...
    bitmap = QBitmap::fromData( QSize(16,  16),  pindown_white_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actHigh); pdis.setPen(disHigh);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  pindown_gray_bits);
    pact.setPen(actMed); pdis.setPen(disMed);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    bitmap = QBitmap::fromData( QSize(16,  16),  pindown_dgray_bits);
    bitmap.setMask(bitmap);
    pact.setPen(actLow); pdis.setPen(disLow);
    pact.drawPixmap(0, 0, bitmap);
    pdis.drawPixmap(0, 0, bitmap);
    pact.end(); pdis.end();
    bitmap = QBitmap::fromData( QSize(16,  16),  pindown_mask_bits);
