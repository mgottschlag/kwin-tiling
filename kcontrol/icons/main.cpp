...
QString IconModule::quickHelp() const
{
  return i18n("<h1>Icons</h1>"
    ...
    "To choose an icon theme click on the name of it and apply your choice by pressing the button \"Apply\" right below. If you do not want to apply your choice you might press the \"Reset\" button to discard your changes.</p>"
