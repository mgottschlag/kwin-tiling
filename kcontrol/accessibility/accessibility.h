...
#include "ui_accessibilityconfigwidget.h"

class AccessibilityConfigWidget : public QWidget, public Ui::AccessibilityConfigWidget
{
public:
  AccessibilityConfigWidget( QWidget *parent ) : QWidget( parent ) {
    setupUi( this );
  }
};
