	...
	: KConfigWidget( parent, name )
{
	...
	qtarch_Label_1->setText( "System data sources are shared among all users of this machine. These data sources may also be used by system services. Only the administrator can configure system data sources." );
...
classSystemDSN::~classSystemDSN()
{
}

void classSystemDSN::applySettings()
{
}

void classSystemDSN::loadSettings()
{
}
