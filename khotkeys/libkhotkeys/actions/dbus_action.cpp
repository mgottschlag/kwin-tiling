...
DBusAction::DBusAction( KConfigGroup& cfg_P, Action_data* data_P )
    : Action( cfg_P, data_P )
    {
...
DBusAction::DBusAction( Action_data* data_P, const QString& app_P, const QString& obj_P,
...
Action* DBusAction::copy( Action_data* data_P ) const
    {
