...
QString Action_data_base::comment() const
    {
    return _comment;
    }
...
QString Action_data_base::name() const
    {
    return _name;
    }
...
void Action_data_base::set_comment( const QString &comment )
    {
    _comment = comment;
    }


void Action_data_base::set_enabled( bool enabled )
    {
    _enabled = enabled;
    }
