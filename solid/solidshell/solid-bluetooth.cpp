...
int main(int argc, char **argv)
{
  ...
  if (args->isSet("commands"))
  {
      ...
      cout << "  solid-bluetooth hardware list [details|nonportableinfo]" << endl;
      ...
      cout << "  solid-bluetooth power query (suspend|scheme|cpufreq)" << endl;
      ...
      cout << "  solid-bluetooth power set (scheme|cpufreq) 'value'" << endl;
      ...
      cout << "  solid-bluetooth power suspend 'method'" << endl;
      cout << i18n("             # Suspend the computer using the given 'method'.\n") << endl;

      cout << endl;

      cout << "  solid-bluetooth network listdevices" << endl;
      cout << i18n("             # List the network devices present.\n") << endl;

      cout << "  solid-bluetooth network listnetworks 'uni'" << endl;
      cout << i18n("             # List the networks known to the device specified by 'uni'.\n") << endl;

      cout << "  solid-bluetooth network query (status|wireless)|(interface 'uni')|(network 'device-uni' 'network-uni')" << endl;
      ...
      cout << "  solid-bluetooth network set wireless (enabled|disabled)" << endl;
      cout << i18n("             # Enable or disable networking on this system.\n") << endl;

      cout << "  solid-bluetooth network set networking (enabled|disabled)" << endl;
      cout << i18n("             # Enable or disable networking on this system.\n") << endl;

      cout << "  solid-bluetooth network set network 'device-uni' 'network-uni' [authentication 'key']" << endl;
      ...
      cout << "  solid-bluetooth bluetooth listadapters" << endl;
      cout << i18n("             # List bluetooth adapters/interfaces\n") << endl;

      cout << "  solid-bluetooth bluetooth defaultadapter" << endl;
      cout << i18n("             # List bluetooth default adapter/interface\n") << endl;

      cout << "  solid-bluetooth bluetooth query (address|bondings|connections|name) (interface 'ubi')" << endl;
      cout << i18n("             # Query information about the bluetooth adapter/interface with 'ubi'\n") << endl;

      cout << "  solid-bluetooth bluetooth set (mode|name) (interface 'ubi') 'value'" << endl;
      cout << i18n("             # Set the bluetooth adapter name.\n"
                    "             # Set the bluetooth adapter mode. Where 'value' is one of:\n"
                    "             # off|connectable|discoverable\n") << endl;

      cout << "  solid-bluetooth bluetooth scan (interface 'ubi')" << endl;
      cout << i18n("             # Scan for bluetooth remote devices.\n") << endl;

      cout << "  solid-bluetooth bluetooth input listdevices" << endl;
      cout << i18n("             # List configured input devices.\n") << endl;

      cout << "  solid-bluetooth bluetooth input (setup|remove|connect|disconnect) (device 'ubi')" << endl;
      ...
      cout << "  solid-bluetooth bluetooth remote (createbonding|removebonding|hasbonding) (device 'ubi')" << endl;
...
bool SolidBluetooth::hwList(bool interfaces, bool system)
{
...
bool SolidBluetooth::hwCapabilities(const QString &udi)
{
...
bool SolidBluetooth::hwProperties(const QString &udi)
{
    const Solid::Device device(udi);
...
bool SolidBluetooth::hwQuery(const QString &parentUdi, const QString &query)
{
...
bool SolidBluetooth::hwVolumeCall(SolidBluetooth::VolumeCallType type, const QString &udi)
{
...
bool SolidBluetooth::powerQuerySuspendMethods()
{
...
bool SolidBluetooth::powerSuspend(const QString &strMethod)
{
...
bool SolidBluetooth::powerQuerySchemes()
{
...
bool SolidBluetooth::powerChangeScheme(const QString &schemeName)
{
...
bool SolidBluetooth::powerQueryCpuPolicies()
{
...
bool SolidBluetooth::powerChangeCpuPolicy(const QString &policyName)
{
...
bool SolidBluetooth::netmgrNetworkingEnabled()
{
...
bool SolidBluetooth::netmgrWirelessEnabled()
{
...
bool SolidBluetooth::netmgrChangeNetworkingEnabled(bool enabled)
{
    Solid::Control::NetworkManager::setNetworkingEnabled(enabled);
    return true;
}

bool SolidBluetooth::netmgrChangeWirelessEnabled(bool enabled)
{
    Solid::Control::NetworkManager::setWirelessEnabled(enabled);
    return true;
}

bool SolidBluetooth::netmgrList()
{
...
bool SolidBluetooth::netmgrListNetworks(const QString  & deviceUni)
{
...
bool SolidBluetooth::netmgrQueryNetworkInterface(const QString  & deviceUni)
{
    cerr << "SolidBluetooth::netmgrQueryNetworkInterface()" << endl;
    Solid::Control::NetworkInterface device = Solid::Control::NetworkManager::findNetworkInterface(deviceUni);
    cout << device << endl;
    return true;
}

bool SolidBluetooth::netmgrQueryNetwork(const QString  & deviceUni, const QString  & networkUni)
{
    cerr << "SolidBluetooth::netmgrQueryNetwork()" << endl;
    Solid::Control::NetworkInterface device = Solid::Control::NetworkManager::findNetworkInterface(deviceUni);
...
bool SolidBluetooth::netmgrActivateNetwork(const QString  & deviceUni, const QString  & networkUni, Solid::Control::Authentication * auth)
{
    Solid::Control::NetworkInterface device = Solid::Control::NetworkManager::findNetworkInterface(deviceUni);
    Solid::Control::Network * network = device.findNetwork(networkUni);
