 ...
 ***************************************************************************/
#ifndef QUICKLAUNCH_ICONAREA_H
#define QUICKLAUNCH_ICONAREA_H
...
class IconArea : public QGraphicsWidget
{
    Q_OBJECT

public:
    IconArea(QGraphicsItem *parent = 0);

    bool iconNamesVisible() const;
    void setIconNamesVisible(bool enable);

    /**
     * Indicates whether this IconArea is locked and thus does not allow
     * adding, removing or reordering icons by drag & drop.
     */
    bool locked() const;

    /**
     * Locks or unlocks this IconArea.
     *
     * @param enable whether this IconArea should be locked, thereby
