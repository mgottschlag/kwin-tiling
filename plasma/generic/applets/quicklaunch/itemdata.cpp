...
ItemData::ItemData(const KUrl& url)
:
...
QString ItemData::description() const
{
    return m_description;
}

QString ItemData::icon() const
{
    return m_icon;
}

void ItemData::populateMimeData(QMimeData *mimeData)
{
...
bool ItemData::canDecode(const QMimeData *mimeData)
{
...
QList<ItemData> ItemData::fromMimeData(const QMimeData *mimeData)
{
    QList<ItemData> data;
...
bool ItemData::hasUrls(const QList<KBookmark> &bookmarkList)
{
...
bool ItemData::hasUrls(const KBookmarkGroup &bookmarkGroup)
{
...
QList<KUrl> ItemData::extractUrls(const QList<KBookmark> &bookmarkList)
{
    QList<KUrl> urlList;
...
QList<KUrl> ItemData::extractUrls(const KBookmarkGroup &bookmarkGroup)
{
    QList<KUrl> urlList;
