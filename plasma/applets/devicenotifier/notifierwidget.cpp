...
NotifierWidget::NotifierWidget( QWidget * parent, Qt::WindowFlags f )
    : QWidget(parent, f),
...
void NotifierWidget::paintEvent(QPaintEvent *e)
{
    QPainter p(this);
...
void NotifierWidget::paintBackground(QPainter* painter, const QRect &exposedRect)
{
